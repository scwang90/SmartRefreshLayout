...
compile 'com.scwang.smartrefresh:SmartRefreshLayout:1.0.4-alpha-11'
compile 'com.scwang.smartrefresh:SmartRefreshHeader:1.0.4-alpha-11'//没有使用特殊Header，可以不加这行
