...
[![Methods](https://img.shields.io/badge/Methods%20%7C%20Size%20-%20813%20%7C%20121%20KB-d9534f.svg)](http://www.methodscount.com/?lib=com.scwang.smartrefresh%3ASmartRefreshLayout%3A1.0.4)
...
compile 'com.scwang.smartrefresh:SmartRefreshLayout:1.1.0-alpha-26'
compile 'com.scwang.smartrefresh:SmartRefreshHeader:1.1.0-alpha-26'//没有使用特殊Header，可以不加这行
compile 'com.android.support:appcompat-v7:25.3.1'//版本 23以上（必须）

//1.1.0 androidx 版本
implementation 'com.scwang.smartrefresh:SmartRefreshLayout:1.1.0-andx-9'
implementation 'com.scwang.smartrefresh:SmartRefreshHeader:1.1.0-andx-9'
