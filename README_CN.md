...
身的环境问题，这花费了我大量的时间，经过我的观察和测试，到目前位置，本库的bug已经越来越少，当然不能说完全没有，但是
...
能帮助解决，需要群主解决，当时要花费群主五分钟以上的时间（不管是本库bug，还是项目bug导致），群主都不会解决这个问题，
如果项目紧急，请付费进入质询群解决（不过注意，付费群中群主会很认真很努力的解决问题，但也不能保证已经能完美解决）或者
转换使用其他的刷新库。
