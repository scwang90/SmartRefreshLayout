...
compile 'com.scwang.smartrefresh:SmartRefreshHeader:1.0.2-alpha-6'//如果使用了特殊的Header
```
...
<!-- ### QQ咨询群 - 477963933 （付费）   -->
<!-- #### 进群须知 -->
<!-- 自开群依赖，还是有很多的朋友提出了很多问题，我也解决了很多问题，其中有大半问题是本库的Bug导致，也有写是使用者项目本 -->
<!-- 身的环境问题，这花费了我打量的时间，经过我的观察和考虑，到目前位置，本库的bug已经越来越少，当然不能说完全没有，但是 -->
...
### QQ讨论群 - 602537182  
#### 进群须知
<!-- 这个群，免费进入，可以在大家可以相互讨论本库的相关使用和出现的问题，群主也会在里面解决问题，不过因为时间原因，如果提 -->
<!-- 出的问题，群成员不能帮助解决，需要群主解决，当时要花费群主五分钟以上的时间（不管是本库bug，还是项目bug导致），群主都 -->
<!-- 不会解决这个问题，如果项目紧急，请付费进入质询群解决（不过注意，付费群中群主会很认真很努力的解决问题，但也不能保证已 -->
<!-- 经能完美解决）或者转换使用其他的刷新库。 -->
