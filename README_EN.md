...
```
compile 'com.scwang.smartrefresh:SmartRefreshLayout:1.1.0-alpha-9'
compile 'com.scwang.smartrefresh:SmartRefreshHeader:1.1.0-alpha-9'//If you use the special Header
