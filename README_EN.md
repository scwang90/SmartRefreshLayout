...
compile 'com.scwang.smartrefresh:SmartRefreshLayout:1.0.3-alpha-4'
compile 'com.scwang.smartrefresh:SmartRefreshHeader:1.0.3-alpha-4'//If you use the special Header
```
