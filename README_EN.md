...
```
compile 'com.scwang.smartrefresh:SmartRefreshLayout:1.1.0-alpha-13'
compile 'com.scwang.smartrefresh:SmartRefreshHeader:1.1.0-alpha-13'//If you use the special Header
